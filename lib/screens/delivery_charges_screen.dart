...
class DeliveryChargesScreen extends StatefulWidget {
  ...
  @override
  State<DeliveryChargesScreen> createState() =>
      _DeliveryChargesScreenState();
}

class _DeliveryChargesScreenState
    extends State<DeliveryChargesScreen> {
  ...
  double get totalDeliveryCharge => filteredOrders.fold(
      0, (sum, o) => sum + o.deliveryCharge);

  double get avgDeliveryCharge => filteredOrders.isEmpty
      ? 0
      : totalDeliveryCharge / filteredOrders.length;
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _summaryCard(
                                label: "Avg per Order",
                                value:
                                    "₹${avgDeliveryCharge.toStringAsFixed(0)}",
                        ...
                        if (filtered.isEmpty)
                          _emptyState(
                              "No delivery charges in this period")
                        else
                          ListView.builder(
                            shrinkWrap: true,
                            physics:
  ...
  Widget _buildOrderCard(Order order,
    ...
    final charge = isDelivery
        ? order.deliveryCharge
        : order.handlingCharge;
    final color = isDelivery ? Colors.orange : Colors.purple;
  ...
  Widget _filterChip(String label, String value) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              selected ? Colors.orange : Colors.grey[100],
          borderRadius: BorderRadius.circular(20),
        ),
        child: Text(
          label,
